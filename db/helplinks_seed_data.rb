HELPS = [{
    ...
    "content" => "<p>The bidding on Lots can be scheduled to open and close automatically, or can be opened and closed manually by the auction organiser. Select which procedure you wish to use for the auction.</p>\r\n<p>Where the automatic opening / closing option is selected the default times entered below will be used to allow bidding. It is possible to alter these default times when inputting individual Lot details.</p>",
    ...
    "content" => "<p>When an auction is organised it is first created in a \"draft\" state which is not available for the public to view.</p>\r\n<p>Once the organiser has created the auction they can submit it for approval by PositiveBid using the \"Organiser submit for approval\" button provided. The auction first enters a \"submitted\" state, and then an \"active\" state once it has been approved by PositiveBid. When active it becomes available for the public to view.</p>\r\n<p>Finally, when the auction has closed the organiser can archive the auction with the \"Organiser archive\" button, which will remove it from public display in the web-application. The auction <b>state</b> can be seen towards the bottom of the table below.</p>",
    ...
    "content" => "The url of the donor website will be used to provide a link to their website from the information about the item in the application. It is optional.",
    ...
    "content" => "<p>When a Lot is first created it is in a \"draft\" state which is not open for the public to view. An \"Organiser publish listing\" button enables the Lot to be published making it publicly viewable.</p>\r\n<p>Bidding on a Lot will either open automatically at the scheduled time, or by the organiser manually opening bidding with the \"Organiser open bidding now\" button provided. Manual opening will over-ride automatic scheduled opening. Two buttons then allow manual closing on a Lot by either initiating a closing procedure which allows further bidding on the Lot for a limited period of time, or by closing the bidding on a Lot immediately.</p>\r\n<p>Finally, a button enables the organiser to mark the Lot as having been paid for, when the winning bidder has made a manual payment.</p>",
        "key" => "lot_show_links",
